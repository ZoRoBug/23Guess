...
$root.MSG_REWARD_CLLB = (function() {

    /**
     * Properties of a MSG_REWARD_CLLB.
     * @exports IMSG_REWARD_CLLB
     * @interface IMSG_REWARD_CLLB
     * @property {number} msgID MSG_REWARD_CLLB msgID
     * @property {number|null} [pid] MSG_REWARD_CLLB pid
     * @property {AwardType|null} [awardType] MSG_REWARD_CLLB awardType
     */

    /**
     * Constructs a new MSG_REWARD_CLLB.
     * @exports MSG_REWARD_CLLB
     * @classdesc Represents a MSG_REWARD_CLLB.
     * @implements IMSG_REWARD_CLLB
     * @constructor
     * @param {IMSG_REWARD_CLLB=} [properties] Properties to set
     */
    function MSG_REWARD_CLLB(properties) {
        if (properties)
    ...
    /**
     * MSG_REWARD_CLLB msgID.
     * @member {number} msgID
     * @memberof MSG_REWARD_CLLB
     * @instance
     */
    MSG_REWARD_CLLB.prototype.msgID = 0;
     ...
     * @instance
     */
    MSG_REWARD_CLLB.prototype.pid = 0;

    /**
     * MSG_REWARD_CLLB awardType.
     * @member {AwardType} awardType
     * @memberof MSG_REWARD_CLLB
     * @instance
     */
    MSG_REWARD_CLLB.prototype.awardType = 1;

    /**
     * Creates a new MSG_REWARD_CLLB instance using the specified properties.
     * @function create
     * @memberof MSG_REWARD_CLLB
     * @static
     * @param {IMSG_REWARD_CLLB=} [properties] Properties to set
     * @returns {MSG_REWARD_CLLB} MSG_REWARD_CLLB instance
     */
    MSG_REWARD_CLLB.create = function create(properties) {
        return new MSG_REWARD_CLLB(properties);
    };

    /**
     * Encodes the specified MSG_REWARD_CLLB message. Does not implicitly {@link MSG_REWARD_CLLB.verify|verify} messages.
     * @function encode
     * @memberof MSG_REWARD_CLLB
     * @static
     * @param {IMSG_REWARD_CLLB} message MSG_REWARD_CLLB message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    MSG_REWARD_CLLB.encode = function encode(message, writer) {
        if (!writer)
    ...
    /**
     * Encodes the specified MSG_REWARD_CLLB message, length delimited. Does not implicitly {@link MSG_REWARD_CLLB.verify|verify} messages.
     ...
     * @returns {$protobuf.Writer} Writer
     */
    MSG_REWARD_CLLB.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };

    /**
     * Decodes a MSG_REWARD_CLLB message from the specified reader or buffer.
     * @function decode
     * @memberof MSG_REWARD_CLLB
     * @static
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {MSG_REWARD_CLLB} MSG_REWARD_CLLB
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    MSG_REWARD_CLLB.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.MSG_REWARD_CLLB();
    ...
    /**
     * Decodes a MSG_REWARD_CLLB message from the specified reader or buffer, length delimited.
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    MSG_REWARD_CLLB.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
    ...
    /**
     * Verifies a MSG_REWARD_CLLB message.
     * @function verify
     * @memberof MSG_REWARD_CLLB
     * @static
     ...
     */
    MSG_REWARD_CLLB.verify = function verify(message) {
    ...
    /**
     * Creates a MSG_REWARD_CLLB message from a plain object. Also converts values to their respective internal types.
     * @function fromObject
     * @memberof MSG_REWARD_CLLB
     * @static
     ...
     * @returns {MSG_REWARD_CLLB} MSG_REWARD_CLLB
     */
    MSG_REWARD_CLLB.fromObject = function fromObject(object) {
        if (object instanceof $root.MSG_REWARD_CLLB)
            return object;
        var message = new $root.MSG_REWARD_CLLB();
    ...
    /**
     * Creates a plain object from a MSG_REWARD_CLLB message. Also converts values to other types if specified.
     * @function toObject
     * @memberof MSG_REWARD_CLLB
     * @static
     * @param {MSG_REWARD_CLLB} message MSG_REWARD_CLLB
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    MSG_REWARD_CLLB.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        var object = {};
        if (options.defaults) {
    ...
    /**
     * Converts this MSG_REWARD_CLLB to JSON.
     * @function toJSON
     * @memberof MSG_REWARD_CLLB
     * @instance
     * @returns {Object.<string,*>} JSON object
     */
    MSG_REWARD_CLLB.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };

    return MSG_REWARD_CLLB;
})();
