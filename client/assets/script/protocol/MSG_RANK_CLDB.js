...
$root.MSG_RANK_CLDB = (function() {

    /**
     * Properties of a MSG_RANK_CLDB.
     * @exports IMSG_RANK_CLDB
     * @interface IMSG_RANK_CLDB
     * @property {number} msgID MSG_RANK_CLDB msgID
     * @property {number|null} [pid] MSG_RANK_CLDB pid
     * @property {RankType|null} [rankType] MSG_RANK_CLDB rankType
     * @property {number|null} [startPos] MSG_RANK_CLDB startPos
     * @property {number|null} [count] MSG_RANK_CLDB count
     * @property {Array.<MSG_RANK_CLDB.IRank>|null} [rankList] MSG_RANK_CLDB rankList
     */

    /**
     * Constructs a new MSG_RANK_CLDB.
     * @exports MSG_RANK_CLDB
     * @classdesc Represents a MSG_RANK_CLDB.
     * @implements IMSG_RANK_CLDB
     * @constructor
     * @param {IMSG_RANK_CLDB=} [properties] Properties to set
     */
    function MSG_RANK_CLDB(properties) {
        this.rankList = [];
        if (properties)
     ...
     * MSG_RANK_CLDB msgID.
     * @member {number} msgID
     * @memberof MSG_RANK_CLDB
     * @instance
     */
    MSG_RANK_CLDB.prototype.msgID = 0;
     ...
     * @instance
     */
    MSG_RANK_CLDB.prototype.pid = 0;

    /**
     * MSG_RANK_CLDB rankType.
     * @member {RankType} rankType
     * @memberof MSG_RANK_CLDB
     * @instance
     */
    MSG_RANK_CLDB.prototype.rankType = 1;

    /**
     * MSG_RANK_CLDB startPos.
     * @member {number} startPos
     * @memberof MSG_RANK_CLDB
     * @instance
     */
    MSG_RANK_CLDB.prototype.startPos = 0;
     ...
     * @instance
     */
    MSG_RANK_CLDB.prototype.count = 0;

    /**
     * MSG_RANK_CLDB rankList.
     * @member {Array.<MSG_RANK_CLDB.IRank>} rankList
     * @memberof MSG_RANK_CLDB
     * @instance
     */
    MSG_RANK_CLDB.prototype.rankList = $util.emptyArray;

    /**
     * Creates a new MSG_RANK_CLDB instance using the specified properties.
     * @function create
     * @memberof MSG_RANK_CLDB
     * @static
     * @param {IMSG_RANK_CLDB=} [properties] Properties to set
     * @returns {MSG_RANK_CLDB} MSG_RANK_CLDB instance
     */
    MSG_RANK_CLDB.create = function create(properties) {
        return new MSG_RANK_CLDB(properties);
    };

    /**
     * Encodes the specified MSG_RANK_CLDB message. Does not implicitly {@link MSG_RANK_CLDB.verify|verify} messages.
     * @function encode
     * @memberof MSG_RANK_CLDB
     * @static
     * @param {IMSG_RANK_CLDB} message MSG_RANK_CLDB message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    MSG_RANK_CLDB.encode = function encode(message, writer) {
        if (!writer)
        ...
        if (message.startPos != null && message.hasOwnProperty("startPos"))
            writer.uint32(/* id 4, wireType 0 =*/32).uint32(message.startPos);
        ...
        if (message.rankList != null && message.rankList.length)
            for (var i = 0; i < message.rankList.length; ++i)
                $root.MSG_RANK_CLDB.Rank.encode(message.rankList[i], writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
        return writer;
    };

    /**
     * Encodes the specified MSG_RANK_CLDB message, length delimited. Does not implicitly {@link MSG_RANK_CLDB.verify|verify} messages.
     ...
     * @returns {$protobuf.Writer} Writer
     */
    MSG_RANK_CLDB.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };

    /**
     * Decodes a MSG_RANK_CLDB message from the specified reader or buffer.
     * @function decode
     * @memberof MSG_RANK_CLDB
     * @static
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {MSG_RANK_CLDB} MSG_RANK_CLDB
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    MSG_RANK_CLDB.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.MSG_RANK_CLDB();
        while (reader.pos < end) {
            ...
            case 3:
                ...
                break;
            case 4:
                message.startPos = reader.uint32();
                break;
            case 5:
            ...
            case 6:
                if (!(message.rankList && message.rankList.length))
                    message.rankList = [];
                message.rankList.push($root.MSG_RANK_CLDB.Rank.decode(reader, reader.uint32()));
                break;
            default:
    ...
    /**
     * Decodes a MSG_RANK_CLDB message from the specified reader or buffer, length delimited.
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    MSG_RANK_CLDB.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
    ...
    /**
     * Verifies a MSG_RANK_CLDB message.
     * @function verify
     * @memberof MSG_RANK_CLDB
     * @static
     ...
     */
    MSG_RANK_CLDB.verify = function verify(message) {
        ...
        if (message.startPos != null && message.hasOwnProperty("startPos"))
            if (!$util.isInteger(message.startPos))
                return "startPos: integer expected";
        if (message.count != null && message.hasOwnProperty("count"))
        ...
        if (message.rankList != null && message.hasOwnProperty("rankList")) {
            ...
            for (var i = 0; i < message.rankList.length; ++i) {
                var error = $root.MSG_RANK_CLDB.Rank.verify(message.rankList[i]);
                if (error)
    ...
    /**
     * Creates a MSG_RANK_CLDB message from a plain object. Also converts values to their respective internal types.
     * @function fromObject
     * @memberof MSG_RANK_CLDB
     * @static
     ...
     * @returns {MSG_RANK_CLDB} MSG_RANK_CLDB
     */
    MSG_RANK_CLDB.fromObject = function fromObject(object) {
        if (object instanceof $root.MSG_RANK_CLDB)
            return object;
        var message = new $root.MSG_RANK_CLDB();
        ...
        if (object.rankList) {
            if (!Array.isArray(object.rankList))
                throw TypeError(".MSG_RANK_CLDB.rankList: array expected");
            message.rankList = [];
            for (var i = 0; i < object.rankList.length; ++i) {
                if (typeof object.rankList[i] !== "object")
                    throw TypeError(".MSG_RANK_CLDB.rankList: object expected");
                message.rankList[i] = $root.MSG_RANK_CLDB.Rank.fromObject(object.rankList[i]);
            }
        }
        return message;
    };
    ...
    /**
     * Creates a plain object from a MSG_RANK_CLDB message. Also converts values to other types if specified.
     * @function toObject
     * @memberof MSG_RANK_CLDB
     * @static
     * @param {MSG_RANK_CLDB} message MSG_RANK_CLDB
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    MSG_RANK_CLDB.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        var object = {};
        ...
        if (options.defaults) {
            object.msgID = 0;
            object.pid = 0;
            object.rankType = options.enums === String ? "UNIVERSE_CROWN" : 1;
            object.startPos = 0;
            object.count = 0;
        }
        ...
        if (message.rankType != null && message.hasOwnProperty("rankType"))
            object.rankType = options.enums === String ? $root.RankType[message.rankType] : message.rankType;
        if (message.startPos != null && message.hasOwnProperty("startPos"))
            object.startPos = message.startPos;
        if (message.count != null && message.hasOwnProperty("count"))
            object.count = message.count;
        if (message.rankList && message.rankList.length) {
            object.rankList = [];
            for (var j = 0; j < message.rankList.length; ++j)
                object.rankList[j] = $root.MSG_RANK_CLDB.Rank.toObject(message.rankList[j], options);
        }
        return object;
    };

    /**
     * Converts this MSG_RANK_CLDB to JSON.
     * @function toJSON
     * @memberof MSG_RANK_CLDB
     * @instance
     * @returns {Object.<string,*>} JSON object
     */
    MSG_RANK_CLDB.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };

    MSG_RANK_CLDB.Rank = (function() {

        /**
         * Properties of a Rank.
         * @memberof MSG_RANK_CLDB
         * @interface IRank
         * @property {number|null} [pid] Rank pid
         * @property {number|null} [level] Rank level
         * @property {number|Long|null} [coinWin] Rank coinWin
         */
         ...
         * @implements IRank
         * @constructor
         * @param {MSG_RANK_CLDB.IRank=} [properties] Properties to set
         */
         ...
         * Rank pid.
         * @member {number} pid
         * @memberof MSG_RANK_CLDB.Rank
         * @instance
         */
        Rank.prototype.pid = 0;
         ...
         * @instance
         */
        Rank.prototype.level = 0;

        /**
         * Rank coinWin.
         * @member {number|Long} coinWin
         * @memberof MSG_RANK_CLDB.Rank
         * @instance
         */
        Rank.prototype.coinWin = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
         ...
         * @static
         * @param {MSG_RANK_CLDB.IRank=} [properties] Properties to set
         * @returns {MSG_RANK_CLDB.Rank} Rank instance
         */
        ...
        /**
         * Encodes the specified Rank message. Does not implicitly {@link MSG_RANK_CLDB.Rank.verify|verify} messages.
         * @function encode
         * @memberof MSG_RANK_CLDB.Rank
         * @static
         * @param {MSG_RANK_CLDB.IRank} message Rank message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        Rank.encode = function encode(message, writer) {
            ...
            if (message.coinWin != null && message.hasOwnProperty("coinWin"))
                writer.uint32(/* id 3, wireType 0 =*/24).sint64(message.coinWin);
            return writer;
        };

        /**
         * Encodes the specified Rank message, length delimited. Does not implicitly {@link MSG_RANK_CLDB.Rank.verify|verify} messages.
         * @function encodeDelimited
         * @memberof MSG_RANK_CLDB.Rank
         * @static
         * @param {MSG_RANK_CLDB.IRank} message Rank message or plain object to encode
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {MSG_RANK_CLDB.Rank} Rank
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        Rank.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.MSG_RANK_CLDB.Rank();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Rank.verify = function verify(message) {
            ...
            if (message.coinWin != null && message.hasOwnProperty("coinWin"))
                if (!$util.isInteger(message.coinWin) && !(message.coinWin && $util.isInteger(message.coinWin.low) && $util.isInteger(message.coinWin.high)))
                    return "coinWin: integer|Long expected";
            return null;
        };
        ...
        Rank.fromObject = function fromObject(object) {
            if (object instanceof $root.MSG_RANK_CLDB.Rank)
                return object;
            var message = new $root.MSG_RANK_CLDB.Rank();
            if (object.pid != null)
                message.pid = object.pid >>> 0;
            if (object.level != null)
                message.level = object.level >>> 0;
            if (object.coinWin != null)
                if ($util.Long)
                    (message.coinWin = $util.Long.fromValue(object.coinWin)).unsigned = false;
                else if (typeof object.coinWin === "string")
                    message.coinWin = parseInt(object.coinWin, 10);
                else if (typeof object.coinWin === "number")
                    message.coinWin = object.coinWin;
                else if (typeof object.coinWin === "object")
                    message.coinWin = new $util.LongBits(object.coinWin.low >>> 0, object.coinWin.high >>> 0).toNumber();
            return message;
        };
         ...
         * @memberof MSG_RANK_CLDB.Rank
         * @static
         * @param {MSG_RANK_CLDB.Rank} message Rank
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        Rank.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                ...
                if ($util.Long) {
                    ...
                    object.coinWin = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                } else
                    object.coinWin = options.longs === String ? "0" : 0;
            }
            if (message.pid != null && message.hasOwnProperty("pid"))
                object.pid = message.pid;
            if (message.level != null && message.hasOwnProperty("level"))
            ...
            if (message.coinWin != null && message.hasOwnProperty("coinWin"))
                if (typeof message.coinWin === "number")
                    object.coinWin = options.longs === String ? String(message.coinWin) : message.coinWin;
                else
                    object.coinWin = options.longs === String ? $util.Long.prototype.toString.call(message.coinWin) : options.longs === Number ? new $util.LongBits(message.coinWin.low >>> 0, message.coinWin.high >>> 0).toNumber() : message.coinWin;
            return object;
        };
