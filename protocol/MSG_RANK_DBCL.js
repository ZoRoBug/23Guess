...
$root.MSG_RANK_DBCL = (function() {

    /**
     * Properties of a MSG_RANK_DBCL.
     * @exports IMSG_RANK_DBCL
     * @interface IMSG_RANK_DBCL
     * @property {number} msgID MSG_RANK_DBCL msgID
     * @property {number|null} [pid] MSG_RANK_DBCL pid
     * @property {number|null} [selfRank] MSG_RANK_DBCL selfRank
     * @property {RankType|null} [rankType] MSG_RANK_DBCL rankType
     * @property {Array.<MSG_RANK_DBCL.IRank>|null} [rankList] MSG_RANK_DBCL rankList
     */

    /**
     * Constructs a new MSG_RANK_DBCL.
     * @exports MSG_RANK_DBCL
     * @classdesc Represents a MSG_RANK_DBCL.
     * @implements IMSG_RANK_DBCL
     * @constructor
     * @param {IMSG_RANK_DBCL=} [properties] Properties to set
     */
    function MSG_RANK_DBCL(properties) {
        this.rankList = [];
        if (properties)
     ...
     * MSG_RANK_DBCL msgID.
     * @member {number} msgID
     * @memberof MSG_RANK_DBCL
     * @instance
     */
    MSG_RANK_DBCL.prototype.msgID = 0;
     ...
     * @instance
     */
    MSG_RANK_DBCL.prototype.pid = 0;

    /**
     * MSG_RANK_DBCL selfRank.
     * @member {number} selfRank
     * @memberof MSG_RANK_DBCL
     * @instance
     */
    MSG_RANK_DBCL.prototype.selfRank = 0;

    /**
     * MSG_RANK_DBCL rankType.
     * @member {RankType} rankType
     * @memberof MSG_RANK_DBCL
     * @instance
     */
    MSG_RANK_DBCL.prototype.rankType = 1;

    /**
     * MSG_RANK_DBCL rankList.
     * @member {Array.<MSG_RANK_DBCL.IRank>} rankList
     * @memberof MSG_RANK_DBCL
     * @instance
     */
    MSG_RANK_DBCL.prototype.rankList = $util.emptyArray;

    /**
     * Creates a new MSG_RANK_DBCL instance using the specified properties.
     * @function create
     * @memberof MSG_RANK_DBCL
     * @static
     * @param {IMSG_RANK_DBCL=} [properties] Properties to set
     * @returns {MSG_RANK_DBCL} MSG_RANK_DBCL instance
     */
    MSG_RANK_DBCL.create = function create(properties) {
        return new MSG_RANK_DBCL(properties);
    };

    /**
     * Encodes the specified MSG_RANK_DBCL message. Does not implicitly {@link MSG_RANK_DBCL.verify|verify} messages.
     * @function encode
     * @memberof MSG_RANK_DBCL
     * @static
     * @param {IMSG_RANK_DBCL} message MSG_RANK_DBCL message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    MSG_RANK_DBCL.encode = function encode(message, writer) {
        if (!writer)
        ...
        if (message.rankType != null && message.hasOwnProperty("rankType"))
            writer.uint32(/* id 4, wireType 0 =*/32).int32(message.rankType);
        if (message.rankList != null && message.rankList.length)
            for (var i = 0; i < message.rankList.length; ++i)
                $root.MSG_RANK_DBCL.Rank.encode(message.rankList[i], writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
        return writer;
    };

    /**
     * Encodes the specified MSG_RANK_DBCL message, length delimited. Does not implicitly {@link MSG_RANK_DBCL.verify|verify} messages.
     ...
     * @returns {$protobuf.Writer} Writer
     */
    MSG_RANK_DBCL.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };

    /**
     * Decodes a MSG_RANK_DBCL message from the specified reader or buffer.
     * @function decode
     * @memberof MSG_RANK_DBCL
     * @static
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {MSG_RANK_DBCL} MSG_RANK_DBCL
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    MSG_RANK_DBCL.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.MSG_RANK_DBCL();
        while (reader.pos < end) {
            ...
            case 5:
                if (!(message.rankList && message.rankList.length))
                    message.rankList = [];
                message.rankList.push($root.MSG_RANK_DBCL.Rank.decode(reader, reader.uint32()));
                break;
            default:
    ...
    /**
     * Decodes a MSG_RANK_DBCL message from the specified reader or buffer, length delimited.
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    MSG_RANK_DBCL.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
    ...
    /**
     * Verifies a MSG_RANK_DBCL message.
     * @function verify
     * @memberof MSG_RANK_DBCL
     * @static
     ...
     */
    MSG_RANK_DBCL.verify = function verify(message) {
        ...
        if (message.rankList != null && message.hasOwnProperty("rankList")) {
            ...
            for (var i = 0; i < message.rankList.length; ++i) {
                var error = $root.MSG_RANK_DBCL.Rank.verify(message.rankList[i]);
                if (error)
    ...
    /**
     * Creates a MSG_RANK_DBCL message from a plain object. Also converts values to their respective internal types.
     * @function fromObject
     * @memberof MSG_RANK_DBCL
     * @static
     ...
     * @returns {MSG_RANK_DBCL} MSG_RANK_DBCL
     */
    MSG_RANK_DBCL.fromObject = function fromObject(object) {
        if (object instanceof $root.MSG_RANK_DBCL)
            return object;
        var message = new $root.MSG_RANK_DBCL();
        ...
        if (object.rankList) {
            if (!Array.isArray(object.rankList))
                throw TypeError(".MSG_RANK_DBCL.rankList: array expected");
            message.rankList = [];
            for (var i = 0; i < object.rankList.length; ++i) {
                if (typeof object.rankList[i] !== "object")
                    throw TypeError(".MSG_RANK_DBCL.rankList: object expected");
                message.rankList[i] = $root.MSG_RANK_DBCL.Rank.fromObject(object.rankList[i]);
            }
        }
        return message;
    };
    ...
    /**
     * Creates a plain object from a MSG_RANK_DBCL message. Also converts values to other types if specified.
     * @function toObject
     * @memberof MSG_RANK_DBCL
     * @static
     * @param {MSG_RANK_DBCL} message MSG_RANK_DBCL
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    MSG_RANK_DBCL.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        var object = {};
        ...
        if (message.rankList && message.rankList.length) {
            ...
            for (var j = 0; j < message.rankList.length; ++j)
                object.rankList[j] = $root.MSG_RANK_DBCL.Rank.toObject(message.rankList[j], options);
        }
        return object;
    };

    /**
     * Converts this MSG_RANK_DBCL to JSON.
     * @function toJSON
     * @memberof MSG_RANK_DBCL
     * @instance
     * @returns {Object.<string,*>} JSON object
     */
    MSG_RANK_DBCL.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };

    MSG_RANK_DBCL.Rank = (function() {
         ...
         * @property {string|null} [nickname] Rank nickname
         */
         ...
         * @implements IRank
         * @constructor
         * @param {MSG_RANK_DBCL.IRank=} [properties] Properties to set
         */
         ...
         * @static
         * @param {MSG_RANK_DBCL.IRank=} [properties] Properties to set
         * @returns {MSG_RANK_DBCL.Rank} Rank instance
         */
        ...
        /**
         * Encodes the specified Rank message. Does not implicitly {@link MSG_RANK_DBCL.Rank.verify|verify} messages.
         * @function encode
         * @memberof MSG_RANK_DBCL.Rank
         * @static
         * @param {MSG_RANK_DBCL.IRank} message Rank message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ...
        /**
         * Encodes the specified Rank message, length delimited. Does not implicitly {@link MSG_RANK_DBCL.Rank.verify|verify} messages.
         * @function encodeDelimited
         * @memberof MSG_RANK_DBCL.Rank
         * @static
         * @param {MSG_RANK_DBCL.IRank} message Rank message or plain object to encode
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {MSG_RANK_DBCL.Rank} Rank
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        Rank.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.MSG_RANK_DBCL.Rank();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Rank.fromObject = function fromObject(object) {
            if (object instanceof $root.MSG_RANK_DBCL.Rank)
                return object;
            var message = new $root.MSG_RANK_DBCL.Rank();
            if (object.pid != null)
                message.pid = object.pid >>> 0;
         ...
         * @memberof MSG_RANK_DBCL.Rank
         * @static
         * @param {MSG_RANK_DBCL.Rank} message Rank
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
