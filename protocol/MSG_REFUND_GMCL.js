...
$root.MSG_REFUND_GMCL = (function() {

    /**
     * Properties of a MSG_REFUND_GMCL.
     * @exports IMSG_REFUND_GMCL
     * @interface IMSG_REFUND_GMCL
     * @property {number} msgID MSG_REFUND_GMCL msgID
     * @property {number|null} [pid] MSG_REFUND_GMCL pid
     * @property {Location|null} [type] MSG_REFUND_GMCL type
     * @property {number|Long|null} [coin] MSG_REFUND_GMCL coin
     */

    /**
     * Constructs a new MSG_REFUND_GMCL.
     * @exports MSG_REFUND_GMCL
     * @classdesc Represents a MSG_REFUND_GMCL.
     * @implements IMSG_REFUND_GMCL
     * @constructor
     * @param {IMSG_REFUND_GMCL=} [properties] Properties to set
     */
    function MSG_REFUND_GMCL(properties) {
        if (properties)
    ...
    /**
     * MSG_REFUND_GMCL msgID.
     * @member {number} msgID
     * @memberof MSG_REFUND_GMCL
     * @instance
     */
    MSG_REFUND_GMCL.prototype.msgID = 0;
     ...
     * @instance
     */
    MSG_REFUND_GMCL.prototype.pid = 0;

    /**
     * MSG_REFUND_GMCL type.
     * @member {Location} type
     * @memberof MSG_REFUND_GMCL
     * @instance
     */
    MSG_REFUND_GMCL.prototype.type = 1;

    /**
     * MSG_REFUND_GMCL coin.
     * @member {number|Long} coin
     * @memberof MSG_REFUND_GMCL
     * @instance
     */
    MSG_REFUND_GMCL.prototype.coin = $util.Long ? $util.Long.fromBits(0,0,true) : 0;

    /**
     * Creates a new MSG_REFUND_GMCL instance using the specified properties.
     * @function create
     * @memberof MSG_REFUND_GMCL
     * @static
     * @param {IMSG_REFUND_GMCL=} [properties] Properties to set
     * @returns {MSG_REFUND_GMCL} MSG_REFUND_GMCL instance
     */
    MSG_REFUND_GMCL.create = function create(properties) {
        return new MSG_REFUND_GMCL(properties);
    };

    /**
     * Encodes the specified MSG_REFUND_GMCL message. Does not implicitly {@link MSG_REFUND_GMCL.verify|verify} messages.
     * @function encode
     * @memberof MSG_REFUND_GMCL
     * @static
     * @param {IMSG_REFUND_GMCL} message MSG_REFUND_GMCL message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    MSG_REFUND_GMCL.encode = function encode(message, writer) {
        if (!writer)
    ...
    /**
     * Encodes the specified MSG_REFUND_GMCL message, length delimited. Does not implicitly {@link MSG_REFUND_GMCL.verify|verify} messages.
     ...
     * @returns {$protobuf.Writer} Writer
     */
    MSG_REFUND_GMCL.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };

    /**
     * Decodes a MSG_REFUND_GMCL message from the specified reader or buffer.
     * @function decode
     * @memberof MSG_REFUND_GMCL
     * @static
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {MSG_REFUND_GMCL} MSG_REFUND_GMCL
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    MSG_REFUND_GMCL.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.MSG_REFUND_GMCL();
    ...
    /**
     * Decodes a MSG_REFUND_GMCL message from the specified reader or buffer, length delimited.
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    MSG_REFUND_GMCL.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
    ...
    /**
     * Verifies a MSG_REFUND_GMCL message.
     * @function verify
     * @memberof MSG_REFUND_GMCL
     * @static
     ...
     */
    MSG_REFUND_GMCL.verify = function verify(message) {
    ...
    /**
     * Creates a MSG_REFUND_GMCL message from a plain object. Also converts values to their respective internal types.
     * @function fromObject
     * @memberof MSG_REFUND_GMCL
     * @static
     ...
     * @returns {MSG_REFUND_GMCL} MSG_REFUND_GMCL
     */
    MSG_REFUND_GMCL.fromObject = function fromObject(object) {
        if (object instanceof $root.MSG_REFUND_GMCL)
            return object;
        var message = new $root.MSG_REFUND_GMCL();
    ...
    /**
     * Creates a plain object from a MSG_REFUND_GMCL message. Also converts values to other types if specified.
     * @function toObject
     * @memberof MSG_REFUND_GMCL
     * @static
     * @param {MSG_REFUND_GMCL} message MSG_REFUND_GMCL
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    MSG_REFUND_GMCL.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        var object = {};
        if (options.defaults) {
            object.msgID = 0;
            object.pid = 0;
            object.type = options.enums === String ? "LOBBY" : 1;
            if ($util.Long) {
        ...
        if (message.type != null && message.hasOwnProperty("type"))
            object.type = options.enums === String ? $root.Location[message.type] : message.type;
        if (message.coin != null && message.hasOwnProperty("coin"))
    ...
    /**
     * Converts this MSG_REFUND_GMCL to JSON.
     * @function toJSON
     * @memberof MSG_REFUND_GMCL
     * @instance
     * @returns {Object.<string,*>} JSON object
     */
    MSG_REFUND_GMCL.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };

    return MSG_REFUND_GMCL;
})();
